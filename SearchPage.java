...
public class SearchPage extends AppCompatActivity {
    ...
    public void goto_OxfordDict(View view)
    {
       internet = checkInternet();
        if(internet == true) {
            Intent intent_def = new Intent(SearchPage.this, com.gladydennyson.dion.onpoint.DefinitionFinal.class);
    ...
    public void goto_Quotes(View view)
    {
        internet = checkInternet();
        if(internet == true) {
        Intent intent_quote = new Intent(SearchPage.this, com.gladydennyson.dion.onpoint.QuotesFinal.class);
    ...
    public void goto_Wikipedia(View view)
    {
        internet = checkInternet();
        if(internet == true) {
            Intent intent_wiki = new Intent(SearchPage.this, com.gladydennyson.dion.onpoint.WikiFinal.class);
    ...
    public void goto_Quora(View view)
    {
        internet = checkInternet();
        if(internet == true) {
            Intent intent_quora = new Intent(SearchPage.this, com.gladydennyson.dion.onpoint.Quora2.class);
    ...
    public void goto_Hindu(View view)
    {
        internet = checkInternet();
        if(internet == true) {
            Intent intent_hindu = new Intent(SearchPage.this, com.gladydennyson.dion.onpoint.HinduMain.class);
